...
[[nodiscard]] bool handleBlockEntityInventoryBreak(ecs::GameplayRegistry& registry, BlockID brokenBlock,
                                                   const glm::ivec3& blockPos, bool dropContents);
...
[[nodiscard]] bool ensureBlockEntityInventoryForPlacedBlock(ecs::GameplayRegistry& registry, BlockID placedBlock,
