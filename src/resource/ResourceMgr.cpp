...
void ResourceMgr::init() {
    ...
    loadShader("transparent_composite", SHADERS_DIR "/chunk_lit.vs", SHADERS_DIR "/transparent_composite.fs");
    loadShader("water_composite", SHADERS_DIR "/chunk_lit.vs", SHADERS_DIR "/water_composite.fs");
    ...
    loadShader("deferred_lighting", SHADERS_DIR "/deferred_lighting.vs", SHADERS_DIR "/deferred_lighting.fs");
    ...
    loadShader("volumetric_temporal", SHADERS_DIR "/fullscreen_triangle.vs", SHADERS_DIR "/volumetric_temporal.fs");
    ...
    loadShader("cloud_target", SHADERS_DIR "/fullscreen_triangle.vs", SHADERS_DIR "/cloud_target.fs");
    loadShader("temporal_resolve", SHADERS_DIR "/fullscreen_triangle.vs", SHADERS_DIR "/temporal_resolve.fs");
    ...
    loadShader("ssao_temporal", SHADERS_DIR "/fullscreen_triangle.vs", SHADERS_DIR "/ssao_temporal.fs");
    loadShader("ssao_upsample", SHADERS_DIR "/fullscreen_triangle.vs", SHADERS_DIR "/ssao_upsample.fs");
    ...
    loadShader("drop_gbuffer", SHADERS_DIR "/drop_gbuffer.vs", SHADERS_DIR "/drop_gbuffer.fs");
    loadShader("item_gbuffer", SHADERS_DIR "/item_gbuffer.vs", SHADERS_DIR "/item_gbuffer.fs");
    loadShader("item_shadow", SHADERS_DIR "/item_shadow.vs", SHADERS_DIR "/item_shadow.fs");
