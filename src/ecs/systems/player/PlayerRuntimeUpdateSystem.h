...
public:
    using Dependencies = SystemDependency<std::tuple<LocalPlayerTag, LookIntentComponent, HotbarIntentComponent,
                                                     SprintFovComponent, MoveIntentComponent, PhysicsBodyComponent>,
