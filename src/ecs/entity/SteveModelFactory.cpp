...
entt::entity SteveModelFactory::createSteve(GameplayRegistry& registry, const glm::vec3& worldPosition) {
    ...
    registry.emplace<LocalTransformComponent>(torso, glm::vec3(0.0f, 1.125f, 0.0f), glm::vec3(0.0f), glm::vec3(1.0f));
    ...
    registry.emplace<LocalTransformComponent>(head, glm::vec3(0.0f, 0.375f, 0.0f), glm::vec3(0.0f), glm::vec3(1.0f));
    ...
    registry.emplace<LocalTransformComponent>(rightArm, glm::vec3(-0.3125f, 0.375f, 0.0f), glm::vec3(0.0f),
                                              glm::vec3(1.0f));
    ...
    registry.emplace<LocalTransformComponent>(leftArm, glm::vec3(0.3125f, 0.375f, 0.0f), glm::vec3(0.0f),
                                              glm::vec3(1.0f));
    ...
    registry.emplace<LocalTransformComponent>(rightLeg, glm::vec3(-0.125f, -0.375f, 0.0f), glm::vec3(0.0f),
                                              glm::vec3(1.0f));
    ...
    registry.emplace<LocalTransformComponent>(leftLeg, glm::vec3(0.125f, -0.375f, 0.0f), glm::vec3(0.0f),
                                              glm::vec3(1.0f));
