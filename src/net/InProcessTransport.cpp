...
std::pair<std::unique_ptr<InProcessTransport>,
          std::unique_ptr<InProcessTransport>> InProcessTransport::createPair() {
    ...
    auto endpointA = std::unique_ptr<InProcessTransport>(
        new InProcessTransport(mutex, queueB, queueA));
    auto endpointB = std::unique_ptr<InProcessTransport>(
        new InProcessTransport(mutex, queueA, queueB));
