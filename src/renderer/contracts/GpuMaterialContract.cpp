...
[[nodiscard]] bool finite(const float value) { return std::isfinite(value); }
...
[[nodiscard]] bool inClosedUnitRange(const float value) { return value >= 0.0f && value <= 1.0f; }
...
[[nodiscard]] bool validAlphaMode(const GpuMaterialAlphaMode mode) {
    ...
    case GpuMaterialAlphaMode::Additive:
        return true;
    }
    return false;
}
...
[[nodiscard]] bool validWorkflow(const GpuMaterialWorkflow workflow) {
    ...
    case GpuMaterialWorkflow::LabPbr:
        return true;
    }
    return false;
}
...
[[nodiscard]] MaterialFieldValidation validateUnitValue(const float value,
                                                        const GpuMaterialField field) {
    if (!finite(value)) {
...
[[nodiscard]] MaterialFieldValidation validateUnitValue(const glm::vec3& value,
                                                        const GpuMaterialField field) {
    if (!finite(value)) {
        return {GpuMaterialNormalizationError::NonFiniteValue, field};
    }
...
[[nodiscard]] MaterialFieldValidation validateUnitValue(const glm::vec4& value,
                                                        const GpuMaterialField field) {
    if (!finite(value)) {
        return {GpuMaterialNormalizationError::NonFiniteValue, field};
    }
...
[[nodiscard]] glm::vec3 definedLabPbrMetalF0(const uint8_t metalId) {
    switch (metalId) {
    case 230u:
        return conductorF0({2.9114f, 2.9497f, 2.5845f}, {3.0893f, 2.9318f, 2.7670f});
    case 231u:
        return conductorF0({0.18299f, 0.42108f, 1.3734f}, {3.4242f, 2.3459f, 1.7704f});
    case 232u:
        return conductorF0({1.3456f, 0.96521f, 0.61722f}, {7.4746f, 6.3995f, 5.3031f});
    case 233u:
        return conductorF0({3.1071f, 3.1812f, 2.3230f}, {3.3314f, 3.3291f, 3.1350f});
    case 234u:
        return conductorF0({0.27105f, 0.67693f, 1.3164f}, {3.6092f, 2.6248f, 2.2921f});
    case 235u:
        return conductorF0({1.9100f, 1.8300f, 1.4400f}, {3.5100f, 3.4000f, 3.1800f});
    case 236u:
        return conductorF0({2.3757f, 2.0847f, 1.8453f}, {4.2655f, 3.7153f, 3.1365f});
    case 237u:
        return conductorF0({0.15943f, 0.14512f, 0.13547f}, {3.9291f, 3.1900f, 2.3808f});
    default:
        std::abort();
    }
}

void setPackedBinding(std::array<glm::uvec4, 3>& packed, const size_t semanticIndex,
...
const char* gpuMaterialNormalizationErrorStableId(const GpuMaterialNormalizationError error) {
    switch (error) {
    case GpuMaterialNormalizationError::None:
        return "None";
    case GpuMaterialNormalizationError::InvalidAlphaMode:
        return "InvalidAlphaMode";
    case GpuMaterialNormalizationError::InvalidWorkflow:
        return "InvalidWorkflow";
    case GpuMaterialNormalizationError::UnknownFlags:
        return "UnknownFlags";
    case GpuMaterialNormalizationError::NonFiniteValue:
        return "NonFiniteValue";
    case GpuMaterialNormalizationError::ValueOutOfRange:
        return "ValueOutOfRange";
    case GpuMaterialNormalizationError::IncompatibleWorkflowExtensions:
        return "IncompatibleWorkflowExtensions";
    case GpuMaterialNormalizationError::VolumeRequiresTransmission:
        return "VolumeRequiresTransmission";
    case GpuMaterialNormalizationError::TransmissionAlphaConflict:
        return "TransmissionAlphaConflict";
    case GpuMaterialNormalizationError::AttenuationDistanceConflict:
        return "AttenuationDistanceConflict";
    case GpuMaterialNormalizationError::UnsupportedLabPbrMetalId:
        return "UnsupportedLabPbrMetalId";
    case GpuMaterialNormalizationError::InvalidLabPbrBaseColor:
        return "InvalidLabPbrBaseColor";
    }
    std::abort();
}
...
const char* gpuMaterialFieldStableId(const GpuMaterialField field) {
    switch (field) {
    case GpuMaterialField::None:
        return "None";
    case GpuMaterialField::AlphaMode:
        return "AlphaMode";
    case GpuMaterialField::Workflow:
        return "Workflow";
    case GpuMaterialField::BaseColorFactor:
        return "BaseColorFactor";
    case GpuMaterialField::EmissiveFactor:
        return "EmissiveFactor";
    case GpuMaterialField::EmissiveStrength:
        return "EmissiveStrength";
    case GpuMaterialField::MetallicFactor:
        return "MetallicFactor";
    case GpuMaterialField::PerceptualRoughnessFactor:
        return "PerceptualRoughnessFactor";
    case GpuMaterialField::NormalScale:
        return "NormalScale";
    case GpuMaterialField::OcclusionStrength:
        return "OcclusionStrength";
    case GpuMaterialField::SpecularGlossinessFactor:
        return "SpecularGlossinessFactor";
    case GpuMaterialField::GlossinessFactor:
        return "GlossinessFactor";
    case GpuMaterialField::DielectricSpecularColorFactor:
        return "DielectricSpecularColorFactor";
    case GpuMaterialField::DielectricSpecularWeightFactor:
        return "DielectricSpecularWeightFactor";
    case GpuMaterialField::ClearcoatFactor:
        return "ClearcoatFactor";
    case GpuMaterialField::ClearcoatPerceptualRoughnessFactor:
        return "ClearcoatPerceptualRoughnessFactor";
    case GpuMaterialField::ClearcoatNormalScale:
        return "ClearcoatNormalScale";
    case GpuMaterialField::TransmissionFactor:
        return "TransmissionFactor";
    case GpuMaterialField::ThicknessFactor:
        return "ThicknessFactor";
    case GpuMaterialField::AlphaCutoff:
        return "AlphaCutoff";
    case GpuMaterialField::Ior:
        return "Ior";
    case GpuMaterialField::AttenuationColor:
        return "AttenuationColor";
    case GpuMaterialField::AttenuationDistance:
        return "AttenuationDistance";
    case GpuMaterialField::GameplaySurfaceFactors:
        return "GameplaySurfaceFactors";
    case GpuMaterialField::Flags:
        return "Flags";
    case GpuMaterialField::LabPbrMetalId:
        return "LabPbrMetalId";
    case GpuMaterialField::LabPbrBaseColor:
        return "LabPbrBaseColor";
    }
    std::abort();
}

bool gpuMaterialTextureUsesSrgb(const GpuMaterialTextureSemantic semantic,
                                const GpuMaterialWorkflow workflow) {
    switch (semantic) {
    ...
    case GpuMaterialTextureSemantic::Thickness:
        return false;
    case GpuMaterialTextureSemantic::Count:
        std::abort();
    }
    std::abort();
}
...
GpuMaterialNormalizationResult normalizeGltfMaterial(const GltfMaterialNormalizationInput& input) {
    if (!validAlphaMode(input.alphaMode)) {
        return failure(GpuMaterialNormalizationError::InvalidAlphaMode,
                       GpuMaterialField::AlphaMode);
    }
    ...
    const std::array<MaterialFieldValidation, 14> validations{
        {validateUnitValue(input.baseColorFactor, GpuMaterialField::BaseColorFactor),
         ...
         validateUnitValue(input.perceptualRoughnessFactor,
                           GpuMaterialField::PerceptualRoughnessFactor),
         validateUnitValue(input.occlusionStrength, GpuMaterialField::OcclusionStrength),
         validateUnitValue(input.specularGlossinessFactor,
                           GpuMaterialField::SpecularGlossinessFactor),
         validateUnitValue(input.glossinessFactor, GpuMaterialField::GlossinessFactor),
         validateUnitValue(input.dielectricSpecularColorFactor,
                           GpuMaterialField::DielectricSpecularColorFactor),
         validateUnitValue(input.dielectricSpecularWeightFactor,
                           GpuMaterialField::DielectricSpecularWeightFactor),
         ...
         validateUnitValue(input.gameplaySurfaceFactors,
                           GpuMaterialField::GameplaySurfaceFactors)}};
    ...
    if (!finite(input.emissiveStrength) || input.emissiveStrength < 0.0f) {
        return failure(finite(input.emissiveStrength)
                           ? GpuMaterialNormalizationError::ValueOutOfRange
                           : GpuMaterialNormalizationError::NonFiniteValue,
                       GpuMaterialField::EmissiveStrength);
    }
    if (!finite(input.normalScale)) {
        return failure(GpuMaterialNormalizationError::NonFiniteValue,
                       GpuMaterialField::NormalScale);
    }
    if (!finite(input.clearcoatNormalScale)) {
        return failure(GpuMaterialNormalizationError::NonFiniteValue,
                       GpuMaterialField::ClearcoatNormalScale);
    }
    if (!finite(input.thicknessFactor) || input.thicknessFactor < 0.0f) {
        return failure(finite(input.thicknessFactor)
                           ? GpuMaterialNormalizationError::ValueOutOfRange
                           : GpuMaterialNormalizationError::NonFiniteValue,
    ...
    if (!finite(input.attenuationDistance) || input.attenuationDistance < 0.0f) {
        return failure(finite(input.attenuationDistance)
                           ? GpuMaterialNormalizationError::ValueOutOfRange
                           : GpuMaterialNormalizationError::NonFiniteValue,
    ...
    if (specularGlossiness && (input.flags & modernExtensionMask) != 0u) {
        return failure(GpuMaterialNormalizationError::IncompatibleWorkflowExtensions,
                       GpuMaterialField::Flags);
    }
    ...
    if (hasVolume && !hasTransmission) {
        return failure(GpuMaterialNormalizationError::VolumeRequiresTransmission,
                       GpuMaterialField::Flags);
    }
    if (hasTransmission && input.alphaMode != GpuMaterialAlphaMode::Transmission) {
        return failure(GpuMaterialNormalizationError::TransmissionAlphaConflict,
                       GpuMaterialField::AlphaMode);
    }
    if (!hasTransmission && input.alphaMode == GpuMaterialAlphaMode::Transmission) {
        return failure(GpuMaterialNormalizationError::TransmissionAlphaConflict,
    ...
    if (hasVolume && !hasInfiniteAttenuationDistance && input.attenuationDistance <= 0.0f) {
        return failure(GpuMaterialNormalizationError::ValueOutOfRange,
                       GpuMaterialField::AttenuationDistance);
    }
    ...
    material.materialFactors = {specularGlossiness ? 0.0f : input.metallicFactor,
                                specularGlossiness ? 1.0f : input.perceptualRoughnessFactor,
                                input.normalScale, input.occlusionStrength};
    material.specularGlossinessFactors =
        glm::vec4(input.specularGlossinessFactor, input.glossinessFactor);
    ...
    material.transmissionVolumeFactors = {input.transmissionFactor, input.thicknessFactor,
                                          input.alphaCutoff, input.ior};
    material.attenuationColorAndDistance =
        glm::vec4(input.attenuationColor, input.attenuationDistance);
    ...
    for (size_t semanticIndex = 0u; semanticIndex < input.textureBindings.size(); ++semanticIndex) {
        setPackedBinding(material.textureIndices, semanticIndex,
                         input.textureBindings[semanticIndex].textureIndex);
        setPackedBinding(material.samplerIndices, semanticIndex,
                         input.textureBindings[semanticIndex].samplerIndex);
    }
    material.modesAndFlags = {static_cast<uint32_t>(input.alphaMode),
                              static_cast<uint32_t>(input.workflow), input.flags,
...
LabPbrSpecularDecodeResult decodeLabPbrSpecular(const std::array<uint8_t, 4>& texel,
    ...
    sample.emission =
        sample.emissionProvided ? static_cast<float>(texel[3]) * (1.0f / 254.0f) : 0.0f;
    return result;
}
