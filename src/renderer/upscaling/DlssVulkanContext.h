...
struct DlssRenderExtentResult {
    ...
    [[nodiscard]] bool succeeded() const {
        return status == DlssVulkanStatus::Success;
    }
};
...
[[nodiscard]] DlssRenderExtentResult queryDlssRenderExtent(
...
[[nodiscard]] DlssJitterResult queryDlssJitter(
    uint64_t frameIndex,
...
public:
    ...
    [[nodiscard]] DlssVulkanDispatchResult dispatch(
    ...
    [[nodiscard]] TemporalExtent outputExtent() const {
        return m_outputExtent;
    }

    [[nodiscard]] TemporalExtent renderExtent() const {
        return m_renderExtent;
    }

    [[nodiscard]] TemporalUpscaleQuality quality() const {
        return m_quality;
    }
