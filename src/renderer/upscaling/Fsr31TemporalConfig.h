...
struct Fsr31RenderExtentResult {
    Fsr31TemporalConfigStatus status =
        Fsr31TemporalConfigStatus::InvalidOutputExtent;
    TemporalExtent extent;
    int32_t sdkError = 0;

    [[nodiscard]] bool succeeded() const {
        return status == Fsr31TemporalConfigStatus::Success;
    }
};

struct Fsr31JitterResult {
    Fsr31TemporalConfigStatus status =
        Fsr31TemporalConfigStatus::InvalidRenderExtent;
...
[[nodiscard]] Fsr31RenderExtentResult queryFsr31RenderExtent(
...
[[nodiscard]] Fsr31JitterResult queryFsr31Jitter(
    uint64_t frameIndex,
