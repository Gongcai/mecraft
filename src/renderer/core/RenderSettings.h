...
struct NrdSettings {
    ...
    // Guide depth is reconstructed with the same jittered projection that
    // produced the G-buffer; this threshold covers real reprojection error at
    // surface boundaries rather than a camera-jitter mismatch.
