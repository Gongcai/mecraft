...
void requirePistonProperties() {
    if (PropIndices::FACING == PropIndices::INVALID || PropIndices::EXTENDED == PropIndices::INVALID ||
        PropIndices::EXTENDED_TRUE == PropIndices::INVALID || PropIndices::EXTENDED_FALSE == PropIndices::INVALID ||
...
bool tryGetOtherPartPosition(const glm::ivec3& pos, const BlockStateId stateId, glm::ivec3& outOtherPos) {
...
BlockID removePistonAssembly(World& world, const glm::ivec3& hitPos, std::vector<glm::ivec3>* removedPositions) {
