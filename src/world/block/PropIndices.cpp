...
uint16_t NORTH_NONE = INVALID;
uint16_t NORTH_SIDE = INVALID;
uint16_t NORTH_UP = INVALID;
uint16_t NORTH_DOWN = INVALID;
uint16_t SOUTH_NONE = INVALID;
uint16_t SOUTH_SIDE = INVALID;
uint16_t SOUTH_UP = INVALID;
uint16_t SOUTH_DOWN = INVALID;
uint16_t EAST_NONE = INVALID;
uint16_t EAST_SIDE = INVALID;
uint16_t EAST_UP = INVALID;
uint16_t EAST_DOWN = INVALID;
uint16_t WEST_NONE = INVALID;
uint16_t WEST_SIDE = INVALID;
uint16_t WEST_UP = INVALID;
uint16_t WEST_DOWN = INVALID;
...
void init() {
    ...
    NORTH_NONE = lookupValue(NORTH, "none");
    NORTH_SIDE = lookupValue(NORTH, "side");
    NORTH_UP = lookupValue(NORTH, "up");
    NORTH_DOWN = lookupValue(NORTH, "down");
    SOUTH_NONE = lookupValue(SOUTH, "none");
    SOUTH_SIDE = lookupValue(SOUTH, "side");
    SOUTH_UP = lookupValue(SOUTH, "up");
    SOUTH_DOWN = lookupValue(SOUTH, "down");
    EAST_NONE = lookupValue(EAST, "none");
    EAST_SIDE = lookupValue(EAST, "side");
    EAST_UP = lookupValue(EAST, "up");
    EAST_DOWN = lookupValue(EAST, "down");
    WEST_NONE = lookupValue(WEST, "none");
    WEST_SIDE = lookupValue(WEST, "side");
    WEST_UP = lookupValue(WEST, "up");
    WEST_DOWN = lookupValue(WEST, "down");
