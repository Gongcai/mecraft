...
inline bool isCornerNeighbor(const glm::ivec3& positionA,
                             const uint16_t facingA,
                             const glm::ivec3& positionB,
...
inline ConnectionDirection connectionDirectionForPlanarOffset(const uint16_t facing,
