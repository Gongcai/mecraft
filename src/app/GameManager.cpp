    ...
    return {{"scope", "rtgi_validation_image"},
            ...
            {"totals",
             {{"pixel_count", stats.pixelCount},
              ...
              {"sky_pixel_count", stats.skyPixelCount},
              {"translucent_pixel_count", stats.translucentPixelCount},
            ...
            {"latest",
             {{"supported", latest.supported},
              ...
              {"sky_pixel_count", latest.skyPixelCount},
              {"translucent_pixel_count", latest.translucentPixelCount},
