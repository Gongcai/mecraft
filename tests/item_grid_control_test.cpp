...
int main() {
    ...
    if (control.onInput({UIInputEventType::PointerMove, 12.0f, 12.0f, 0}) != UIEventResult::Handled) {
    ...
    if (control.onInput({UIInputEventType::PointerDown, 12.0f, 12.0f, 0}) != UIEventResult::Consumed) {
    ...
    if (control.onInput({UIInputEventType::PointerMove, 0.0f, 0.0f, 0}) != UIEventResult::Ignored) {
