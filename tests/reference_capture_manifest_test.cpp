...
constexpr std::array<ExpectedCapture, 20u> kExpectedCaptures{
    {{"voxel", "vulkan", "../scenes/m0_voxel_baseline.json", "m0_voxel_baseline",
      app::validation::kValidationSceneContractVersion1, "0f156488f9ade92e", "93b8b518406d50f9",
      "m0_voxel_render_settings", "a64f59f7e206230c", "m0_voxel_baseline_vulkan_1280x720.png", 1511309u,
     ...
     {"model", "vulkan", "../scenes/m0_model_damaged_helmet.json", "m0_model_damaged_helmet",
      app::validation::kValidationSceneContractVersion1, "1da28c807bd28f56", "6f33df94f7766d10",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m0_model_damaged_helmet_vulkan_1280x720.png", 1234823u,
     ...
     {"voxel", "opengl", "../scenes/m0_voxel_baseline.json", "m0_voxel_baseline",
      app::validation::kValidationSceneContractVersion1, "0f156488f9ade92e", "93b8b518406d50f9",
      "m0_voxel_render_settings", "a64f59f7e206230c", "m0_voxel_baseline_opengl_1280x720.png", 1559880u,
     ...
     {"model", "opengl", "../scenes/m0_model_damaged_helmet.json", "m0_model_damaged_helmet",
      app::validation::kValidationSceneContractVersion1, "1da28c807bd28f56", "6f33df94f7766d10",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m0_model_damaged_helmet_opengl_1280x720.png", 1254074u,
     ...
     {"voxel", "vulkan", "../scenes/v02_cave_turn.json", "v02_cave_turn",
      app::validation::kValidationSceneContractVersion, "e08e28e1168e5c99", "87e07b85195fdded",
      "m0_voxel_render_settings", "a64f59f7e206230c", "v02_cave_turn_vulkan_1280x720.png", 1605634u, "bb63c81b1fe7717c",
      "d83fa8c171838803a5c6dad6af65b257f034b6ffd6ee8478cbd937e2032c486d"},
     {"voxel", "opengl", "../scenes/v02_cave_turn.json", "v02_cave_turn",
      app::validation::kValidationSceneContractVersion, "e08e28e1168e5c99", "87e07b85195fdded",
      "m0_voxel_render_settings", "a64f59f7e206230c", "v02_cave_turn_opengl_1280x720.png", 1599216u, "292b8f0614f94eba",
     ...
     {"voxel", "vulkan", "../scenes/v07_local_light_village.json", "v07_local_light_village",
      app::validation::kValidationSceneContractVersion, "0f45db88f1a99f52", "cc6a83ed668b12b5",
      "m0_voxel_render_settings", "a64f59f7e206230c", "v07_local_light_village_vulkan_1280x720.png", 1927321u,
     ...
     {"voxel", "opengl", "../scenes/v07_local_light_village.json", "v07_local_light_village",
      app::validation::kValidationSceneContractVersion, "0f45db88f1a99f52", "cc6a83ed668b12b5",
      "m0_voxel_render_settings", "a64f59f7e206230c", "v07_local_light_village_opengl_1280x720.png", 1910247u,
     ...
     {"model", "vulkan", "../scenes/m07_probe_interior.json", "m07_probe_interior",
      app::validation::kValidationSceneContractVersion, "c9a6a4dee0bd3609", "c17f7838a2a58df0",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m07_probe_interior_vulkan_1280x720.png", 1004315u,
     ...
     {"model", "opengl", "../scenes/m07_probe_interior.json", "m07_probe_interior",
      app::validation::kValidationSceneContractVersion, "c9a6a4dee0bd3609", "c17f7838a2a58df0",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m07_probe_interior_opengl_1280x720.png", 827902u,
     ...
     {"voxel", "vulkan", "../scenes/v01_window_room.json", "v01_window_room",
      app::validation::kValidationSceneContractVersion, "2d6b6c5ba4209093", "926b9e7d3f02af9b",
      "m0_voxel_render_settings", "a64f59f7e206230c", "v01_window_room_vulkan_1280x720.png", 1195689u,
     ...
     {"voxel", "opengl", "../scenes/v01_window_room.json", "v01_window_room",
      app::validation::kValidationSceneContractVersion, "2d6b6c5ba4209093", "926b9e7d3f02af9b",
      "m0_voxel_render_settings", "a64f59f7e206230c", "v01_window_room_opengl_1280x720.png", 1276106u,
     ...
     {"model", "vulkan", "../scenes/m01_material_grid.json", "m01_material_grid",
      app::validation::kValidationSceneContractVersion, "cd22210cfcb39e98", "39d7d82f9711135e",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m01_material_grid_vulkan_1280x720.png", 1234187u,
     ...
     {"model", "opengl", "../scenes/m01_material_grid.json", "m01_material_grid",
      app::validation::kValidationSceneContractVersion, "cd22210cfcb39e98", "39d7d82f9711135e",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m01_material_grid_opengl_1280x720.png", 1251175u,
     ...
     {"model", "vulkan", "../scenes/m02_damaged_helmet.json", "m02_damaged_helmet",
      app::validation::kValidationSceneContractVersion, "c9cca1c2062c5f8e", "1c0a7939ab2fcdf6",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m02_damaged_helmet_vulkan_1280x720.png", 1455565u,
     ...
     {"model", "opengl", "../scenes/m02_damaged_helmet.json", "m02_damaged_helmet",
      app::validation::kValidationSceneContractVersion, "c9cca1c2062c5f8e", "1c0a7939ab2fcdf6",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m02_damaged_helmet_opengl_1280x720.png", 1490078u,
     ...
     {"model", "vulkan", "../scenes/m03_sponza_atrium.json", "m03_sponza_atrium",
      app::validation::kValidationSceneContractVersion, "5c46b72ce7a2139c", "0bb11dd13d10c191",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m03_sponza_atrium_vulkan_1280x720.png", 1452716u,
     ...
     {"model", "opengl", "../scenes/m03_sponza_atrium.json", "m03_sponza_atrium",
      app::validation::kValidationSceneContractVersion, "5c46b72ce7a2139c", "0bb11dd13d10c191",
      "m0_model_render_settings", "26b5990e49b5e2a8", "m03_sponza_atrium_opengl_1280x720.png", 1180902u,
     ...
     {"voxel", "vulkan", "../scenes/m3_voxel_rtgi_cave.json", "m3_voxel_rtgi_cave",
      app::validation::kValidationSceneContractVersion, "f555ab3a2d85b3b4", "87e07b85195fdded",
      app::validation::kValidationRtgiVoxelRenderSettingsId, "f102d1561423ccc6",
     ...
     {"model", "vulkan", "../scenes/m3_model_rtgi_sponza.json", "m3_model_rtgi_sponza",
      app::validation::kValidationSceneContractVersion, "f472f91c279cb22c", "0bb11dd13d10c191",
      app::validation::kValidationRtgiModelRenderSettingsId, "b8afb7f84be62d98",
