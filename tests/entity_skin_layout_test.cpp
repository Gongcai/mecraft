...
int main() {
    ...
    const auto classic = ecs::tryParseEntitySkinLayoutId("minecraft:classic_64x32");
    require(classic.has_value(), "classic skin layout id should parse");
    require(ecs::entitySkinLayoutId(*classic) == "minecraft:classic_64x32",
            "classic skin layout should keep its canonical id");
