...
int main() {
    ...
    if (!game::redstone::isControlBlock(BlockRegistry::requireIdByName("minecraft:lever")) ||
        ...
        return fail(
            "lever, buttons, repeater, comparator, and openable blocks should be right-click redstone controls");
    }
    ...
    if (leverOnVariant == nullptr || leverOnVariant->model == nullptr ||
    ...
    if (leverOffVariant == nullptr || leverOffVariant->model == nullptr ||
    ...
    if (buttonOnVariant == nullptr || buttonOnVariant->model == nullptr ||
    ...
    const BlockStateId repeaterDelay1 = BlockStateRegistry::getState(
        BlockRegistry::requireIdByName("minecraft:repeater"), PropIndices::DELAY, PropIndices::DELAY_1);
    ...
    const BlockStateId comparatorCompare = BlockStateRegistry::getState(
        BlockRegistry::requireIdByName("minecraft:comparator"), PropIndices::MODE, PropIndices::MODE_COMPARE);
    ...
    const BlockStateId trapdoorClosedPowered =
        openableState(BlockRegistry::requireIdByName("minecraft:oak_trapdoor"), false, true);
    ...
    const BlockStateId fenceGateClosed =
        openableState(BlockRegistry::requireIdByName("minecraft:oak_fence_gate"), false, false);
