...
- 本项目需要高性能开发，严禁使用try catch等异常捕获方法，使用std::optinal或错误码进行处理，本项目是C++17项目，不要使用std::expected
# 参考资源
在开发时，如果需要我的世界原版贴图素材，可以从D:\project\minecraft-vanilla-assets搜索获取，该文件夹内有1.21.11和1.7.10两个版本的贴图素材。